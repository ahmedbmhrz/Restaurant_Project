...
export function QuickActionModal({ actionType, isOpen, onClose }) {
    ...
    if (actionType === 'product') {
        ...
        description = "Appoint new leadership for a specific branch.";
                                    ...
                                    {branches.map(b => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start gap-2">
                                                ...
                                                {actionType === 'manager' && !b.hasManager && (
                                                    <span className="flex-shrink-0 bg-rose-100 text-rose-600 text-[8px] font-black uppercase px-1.5 py-0.5 rounded-md animate-pulse">
                                                        Need Manager
                                                    </span>
                                                )}
                                            </div>
                                            ...
                                            {b.hasManager && (
                                                <div className="text-[9px] mt-1 text-emerald-600 font-medium truncate flex items-center gap-1">
                                                    <div className="w-1 h-1 rounded-full bg-emerald-500" />
                                                    Managed by {b.managerName}
                                                </div>
                                            )}
                                        </div>
                                    ))}
